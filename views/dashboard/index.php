<div class="main-content">
    <div class="page-header" style="flex-wrap: wrap; gap: 1rem;">
        ...
        <form action="<?php echo "http://" . $_SERVER['HTTP_HOST'] . "/Taller_Inventario-main/dashboard"; ?>" method="GET" style="display: flex; gap: 10px; align-items: center; background: white; padding: 10px 15px; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05);">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 1.5rem; margin-bottom: 2rem;">
        ...
        <div class="card card-hover">
            <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 1rem;">
                ...
                <h3 style="margin: 0; font-size: 1.3rem;">Asignaciones del Día</h3>
            </div>
            <div style="font-size: 2.5rem; font-weight: 700; color: var(--warning);"><?php echo $asignacionesActivas; ?></div>
            <p style="margin: 0; color: var(--text-muted); font-size: 0.9rem;">Entregas de tela realizadas</p>
        </div>

        <div class="card card-hover" style="background: linear-gradient(135deg, #10B981, #059669); color: white;">
            <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 1rem;">
                <div style="background: rgba(255,255,255,0.2); color: white; width: 48px; height: 48px; border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 1.5rem;">
                    <i class="fa-solid fa-check-double"></i>
                </div>
                <h3 style="margin: 0; font-size: 1.3rem;">Producción Neta</h3>
            </div>
            <div style="font-size: 2.5rem; font-weight: 700; color: white;"><?php echo $totalDiaBuenas; ?></div>
            <p style="margin: 0; color: rgba(255,255,255,0.8); font-size: 0.9rem;">Piezas buenas (mermas descontadas)</p>
        </div>

        <div class="card card-hover" style="background: linear-gradient(135deg, #EF4444, #DC2626); color: white;">
            <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 1rem;">
                <div style="background: rgba(255,255,255,0.2); color: white; width: 48px; height: 48px; border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 1.5rem;">
                    <i class="fa-solid fa-triangle-exclamation"></i>
                </div>
                <h3 style="margin: 0; font-size: 1.3rem;">Mermas Registradas</h3>
            </div>
            <div style="font-size: 2.5rem; font-weight: 700; color: white;"><?php echo $totalDiaMalas; ?></div>
            <p style="margin: 0; color: rgba(255,255,255,0.8); font-size: 0.9rem;">Productos defectuosos reportados</p>
        </div>
    </div>
